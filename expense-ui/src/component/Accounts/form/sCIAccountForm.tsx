...
import { SCIAccount } from "../../../modal/response/Account";
import TagSelect from "../../Tag/TagSelect";
import AccountModal from "../modal";
import { AdapterMoment } from '@mui/x-date-pickers/AdapterMoment';


export interface SCIAccountFormProps {
    form: FormValidation<SCIAccount>;
    open: boolean;
...
export default function SCIAccountForm(props: SCIAccountFormProps) {
